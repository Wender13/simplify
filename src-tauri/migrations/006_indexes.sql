...
CREATE INDEX IF NOT EXISTS idx_transaction_user ON transactions(id_user);
CREATE INDEX IF NOT EXISTS idx_target_user      ON financial_target(id_user);

CREATE INDEX IF NOT EXISTS idx_transaction_category ON transactions(id_category);
CREATE INDEX IF NOT EXISTS idx_transaction_account     ON transactions(id_account);
CREATE INDEX IF NOT EXISTS idx_target_category      ON financial_target(id_category);

CREATE INDEX IF NOT EXISTS idx_transaction_user_date ON transactions(id_user, transaction_date);
